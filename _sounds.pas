...
begin
   if(s=nil)or(_menu)or(_ded)then exit;

   if(u>0)then
    with _units[u] do
     if(_nhp(x,y,r)=false)then exit;
...
begin
   ...
   if(_ded)then begin InitSound:=true; exit; end;
   ...
   snd_l_dron_p    :=loadSND('l_dron_p.WAV');
   snd_l_dron_a    :=loadSND('l_dron_a.WAV');
   snd_l_octo_a    :=loadSND('l_octo_a.WAV');
   snd_l_octo_c    :=loadSND('l_octo_c.WAV');
   snd_l_octo_d    :=loadSND('l_octo_d.WAV');
   snd_l_octo_p    :=loadSND('l_octo_p.WAV');
   snd_l_spawn     :=loadSND('l_spawn.WAV');
   snd_l_cy_p      :=loadSND('l_cy_p.WAV');
   snd_l_cy_c      :=loadSND('l_cy_c.WAV');
   snd_l_cy_d      :=loadSND('l_cy_d.WAV');
   snd_l_cy_a1     :=loadSND('l_cy_a1.WAV');
   snd_l_cy_a2     :=loadSND('l_cy_a2.WAV');
   snd_l_cy_a      :=loadSND('l_cy_a.WAV');
   snd_l_cy_f      :=loadSND('l_cy_f.WAV');

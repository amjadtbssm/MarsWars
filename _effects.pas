   ...
   for ei:=1 to vid_mvs do
    with _effects[ei] do
     ...
     begin
        ...
        case e of
          UID_LostSoul   : spr:=@spr_lostsoul[28-(t div 8)];
          UID_Pain       : spr:=@spr_pain[37-(t div 8)];
          ...
          MID_Revenant,
          MID_RevenantS  : spr:=@spr_h_p4[10-(t div 8)];
          EID_ArchFire   : spr:=@spr_h_p6[7-(t div 8)];
          UID_HMilitaryUnit : begin spr:=@spr_UMilitaryUnit[3]; alpha:=t*4; end;
        else
          spr:=@spr_dummy;
        end;
